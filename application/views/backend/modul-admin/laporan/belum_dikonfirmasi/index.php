                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <?php echo anchor('produk/konfirmasi/'.$data->id_pembayaran, '<i class="material-icons">done_all</i>', 'class="btn btn-danger btn-circle waves-effect waves-circle waves-float"'); ?>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
