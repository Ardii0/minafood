                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php echo anchor('pengguna/pengguna-delete/' . $val->id, '<i class="material-icons">delete</i>', 'class="btn btn-danger btn-circle waves-effect waves-circle waves-float btn-hapus"'); ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
